...
<head>
    ...
    @if (App::getLocale() == 'ar')
        <html lang="ar" dir="rtl">
        <link href="{{ URL::asset('assets/css/arabic/soft-ui-dashboard-ar.css') }}" rel="stylesheet">
        <link href="{{ URL::asset('assets/css/arabic/nucleo-svg.css') }}" rel="stylesheet" />
        <link href="{{ URL::asset('assets/css/arabic/nucleo-icons.css') }}" rel="stylesheet" />
        <link id="pagestyle" href="{{ URL::asset('assets/css/arabic/soft-ui-dashboard.css?v=1.0.7') }}"
            rel="stylesheet" />
    @else
        <html lang="en" dir="ltr">
        <link href="{{ URL::asset('assets/css/english/soft-ui-dashboard-ar.css') }}" rel="stylesheet">
        <link href="{{ URL::asset('assets/css/english/nucleo-icons.css') }}" rel="stylesheet" />
        <link href="{{ URL::asset('assets/css/english/nucleo-svg.css') }}" rel="stylesheet" />
        <link id="pagestyle" href="{{ URL::asset('assets/css/english/soft-ui-dashboard.css?v=1.0.7') }}"
            rel="stylesheet" />
    @endif
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link  " href="{{ route('dashboard.index') }}">
                        ...
                        <span class="nav-link-text ms-1">{{ trans('dash.Dashboard') }}</span>
                    </a>
                </li>
                <li class="nav-item">
        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
            ...
            <div class="container-fluid py-1 px-3">
                ...
                <ul class="navbar-nav  justify-content-end">
                    ...
                    <li class="nav-item px-3 d-flex align-items-center" style="padding-right: 2%">
                ...
                <li class="nav-item d-flex align-items-center" style="padding-left: 20%">
                ...
                <div class="row align-items-center justify-content-lg-between">
                    <div class="col-lg-6 mb-lg-0 mb-4">
                        <div class="copyright text-center text-sm text-muted text-lg-start">
                            {{ trans('dash.Rights') }} © TeachMe-Zilla {{ trans('dash.Developer') }}
                            <a href="#" class="font-weight-bold" target="_blank">Ibrahim
                                Al-kousa</a>
                        ...
                        <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                            ...
                            <li class="nav-item">
                                <a href="#" class="nav-link text-muted"
                                    target="_blank">{{ trans('dash.About-us') }}</a>
                            </li>
                            <li class="nav-item">
                                <a href="#" class="nav-link text-muted"
                                    target="_blank">{{ trans('dash.Blog') }}</a>
                            </li>
                            <li class="nav-item">
                                <a href="#" class="nav-link pe-0 text-muted"
                                    target="_blank">{{ trans('dash.License') }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="card shadow-lg ">
            <div class="card-header pb-0 pt-3 ">
                <div class="float-start">
                    <h5 class="mt-3 mb-0">TeachMe-Zilla</h5>
                    <p>{{ trans('dash.Paragraph') }}</p>
                </div>
            ...
            <div class="card-body pt-sm-3 pt-0">
                ...
                <div class="d-flex">
                    <button class="btn bg-gradient-primary w-100 px-3 mb-2 active" data-class="bg-transparent"
                        onclick="sidebarType(this)">{{ trans('dash.Transparent') }}</button>
                    <button class="btn bg-gradient-primary w-100 px-3 mb-2 ms-2 " data-class="bg-white"
                        onclick="sidebarType(this)">{{ trans('dash.white') }}</button>
                </div>
                {{-- <p class="text-sm d-xl-none d-block mt-2">You can change the sidenav type just on desktop view.</p> --}}
